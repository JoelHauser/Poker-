...
public class Startup(PokerLog log) : IOnLoad
{
    public Task OnLoadAsync(CancellationToken cancellationToken)
    {
        ...
        // Said plainly and at boot, because the alternative is somebody discovering it
        // by watching a stash that never changes and assuming the mod is broken.
        log.Info("THE CHIPS ARE NOT CURRENCY IN THIS BUILD. Nothing is taken and nothing is paid.");
